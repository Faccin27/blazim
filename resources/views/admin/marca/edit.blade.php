    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.marca.fotos', ['marca' => $marca->id]) }}">Fotos</a>
                </li>
            </ul>

            <form class="row g-3" action="{{ route('admin.marca.update', ['marca' => $marca->id]) }}" onsubmit="crudHelper.Alterar(event, this)">

                <div class="form-group col-md-6">
                    <label for="nome" class="form-label">Nome</label>
                    <input id="nome" class="form-control" type="text" name="nome" value="{{ $marca->nome }}" maxlength="255">
                </div>

                <div class="form-group col-md-6">
                    <label for="url" class="form-label">Url</label>
                    <input id="url" class="form-control" type="url" name="url" value="{{ $marca->url }}" maxlength="255">
                </div>
